...
MODEL_ID="/apdcephfs_cq10/share_1615176/cq2/macy/BiosERC/llm_model/llama3.2-3b"   #  "meta-llama/Llama-2-7b-hf"  
DATANAME="iemocap"   # iemocap | meld | emorynlp
EXTRACT_PROMTING_LLM_ID="llama3.2-3b" # Meta-Llama-3-8B-Instruct
