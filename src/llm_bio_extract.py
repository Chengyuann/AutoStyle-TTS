...
model_name = '/apdcephfs_cq10/share_1615176/cq2/macy/BiosERC/llm_model/llama3.2-3b'
        ...
        try:
            ...
            with torch.no_grad():
                for i, speaker_promts_in_batch in enumerate(data_loader):
                    ...
                    print(f"Input Embedding Shape (before generation): {input_embeddings.shape}")
                    with torch.no_grad():
