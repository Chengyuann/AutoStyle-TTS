...
if __name__=='__main__':
    ...
    parser.add_argument('--data_folder', type=str,  help='path folder save all data', default='./cndata/')
    parser.add_argument('--output_folder', type=str,  help='path folder save all data', default='./finetuned_llm_cn/')
    ...
    if hasattr(tokenizer, "chat_template"):
        print("=" * 50)
        print("Existing chat template in tokenizer:")
        print(tokenizer.chat_template)  # 打印当前的聊天模板内容
        print("=" * 50)
