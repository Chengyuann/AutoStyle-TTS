...
def main(args):
    ...
    #     style_wav = load_wav(style_wav_path,16000)
    #     style =  os.path.basename(style_wav_path)[:-8]
    #     name = style.split("_")[0]
    #     style_json = '/apdcephfs_cq10/share_1615176/cq2/rodenluo/tts_vc/test_data/style/YuanMengZhiXing/json/'+ name + '.json'
