...
def main(args):
    ...
    if milvus_insert_data:
        try:
            # Insert data as list of dicts
            res = client.insert(
                collection_name=collection_name,
                data=milvus_insert_data
            )
        ...
        for i, item in enumerate(milvus_insert_data):
            ...
            if search_results:
                for res in search_results[0]:
                    ...
                    print(f"Query ID: {i+1}, Retrieved ID: {retrieved_id}, Distance: {distance}, File ID: {retrieved_file_id}, Text: {text}")
            else:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_folder', type=str, nargs='+', default=[
        ...
        '/apdcephfs_cq10/share_1615176/cq2/macy/tts/json_talk/ex03-ex01_angry_001_final.json',
        '/apdcephfs_cq10/share_1615176/cq2/macy/tts/json_talk/ex03-ex01_happy_001_final.json'
    ], 
